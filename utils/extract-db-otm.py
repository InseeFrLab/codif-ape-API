...
def sample_data(df_path: str, n_lines: str):
    ...
    # Récupérer les lignes où categorie_demande est "CG" et apet_finale commence par `01`, `02`, ou `03`
    df_cg_apet_010203 = df[(df['categorie_demande'] == 'CG') & (df['apet_finale'].str.match(r'^(01|02|03)'))]
