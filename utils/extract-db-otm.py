    ...
    for categorie, partition_df in stratified_sample.groupby("categorie_demande"):
        if categorie in ["CG"]:
            partition_file = os.path.join(
                f"s3://projet-ape/label-studio/annotation-campaign-2024/rev-NAF2025/{categorie}/data-samples/queue/extrait_{categorie}_sirene_last_date_{'unavaible_for_now'}.parquet"
            )
